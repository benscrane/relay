const FEATURES = [
  ...
  {
    title: 'Real-Time Request Logging',
    description:
  ...
  {
    title: 'Dynamic Response Rules',
    description:
      'Configure conditional responses based on request method, path, headers, or body. Use template variables like {{$uuid}} and {{request.body.field}}.',
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        <path
          strokeLinecap="round"
  ...
  },
  {
    ...
    description:
      'Runs on Cloudflare\'s edge network — globally distributed, always fast, zero servers to manage. Just create and start sending requests.',
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        <path
          strokeLinecap="round"
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {FEATURES.map((feature) => (
            <div
              key={feature.title}
              className="card bg-base-200/50 border border-base-300 p-6 hover:border-primary/30 transition-colors"
            >
